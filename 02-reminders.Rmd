...
Later we will find it useful to remember L\'{e}vy's continuity theorem (Theorem \@ref(thm:levy)), which we do not prove since it is fairly well known, but complete proofs are available in Section 18.1 of @Williams and Theorems 14.15 and 18.21 of @Fristedt.
...
knitr::kable(
  head(iris, 5), caption = 'Here is a table. Note the variable names in the column headings. You must not do this in your dissertation. Please also remember the Caption Test from the EDA with R lelcture notes; it is as relevant for tables as for plots.',
  booktabs = TRUE
)
```
