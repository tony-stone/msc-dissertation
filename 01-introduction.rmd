...
by undirected graphs with a vertex representing each record and an edge 
...
had a match score greater than the threshold.

A second representation may include all compared edges with their match score 
(suitably transformed) as the weight of the edge. If no blocking is used, this 
graph will be complete but otherwise this will not be the case.

A third representation may include not just the overall match score of 
pairwise record comparisons (edges) but also, for each compared attribute, 
the contributing component to the overall match score as additional edge 
attributes.
